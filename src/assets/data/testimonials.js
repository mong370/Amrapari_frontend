const testimonials = [
  ...
  },
  {
    ...
    name: {
      bn: 'অংচুথিং মার্মা',
      en: 'Angchuthing Marma'
    },
    institution: {
      bn: 'কম্পিউটার সায়েন্স এন্ড ইঞ্জিনিয়ারিং বিভাগ, চট্টগ্রাম',
      en: 'Department of Computer Science and Engineering, Chattogram'
    },
    year: {
      bn: '৪র্থ বর্ষ',
      en: '4th Year'
    ...
    quote: {
      bn: 'ছোটবেলা থেকেই বিজ্ঞানের প্রতি আমার আগ্রহ ছিল।',
      en: 'I had an interest in science since childhood.'
    },
    session: {
      bn: 'সেশন: ২০১৬',
      en: 'Session: 2016'
